...
| 섹션 | 무엇을 | 비고 | 교재 쪽 |
|---|---|---|---|
| **[01](01_Claude시작하기.md)** | Claude 시작하기 | 웹과 앱의 차이 · 요금제 · 무료로 어디까지 · 한도 | p.5–11 |
| **[02](02_설치하기.md)** | 설치하기 | 계정 · 다운로드 · 「예」 · 「다시 시작」 · 완전 종료 · 응급처치 | p.12–19 |
| **[03](03_사전준비프로그램.md)** | 사전 준비 프로그램 | Node.js · uv · Git · **여기서 손이 갑니다** | p.20–29 |
| **[04](04_회원가입과커넥터.md)** | 회원가입과 커넥터 | 커넥터 · PlayMCP · **★ 업무 활용 지침 — 붙여넣기 한 번** · Code 지침 · gstack | p.30–38 |
| **[05](05_MCP와API.md)** | MCP 와 API | 설정 파일 · 인증키 · Firecrawl · datagokr · **기본 config 8개 설명** | p.39–52 · p.112–120 |
| **[06](06_스킬.md)** | 스킬 | 공식 스킬 3개 검색 설치 · 마켓플레이스 · 스킬제작소 | p.53–60 |
| **[07](07_프로젝트_아티팩트_예정됨.md)** | 프로젝트 · 아티팩트 · 예정됨 | 섹션 08 실습에서 바로 씁니다 | p.61–74 |
| **[08](08_실전_테마레이더.md)** | 실전 — 테마 레이더 | 화면 하나를 직접 만듭니다 · Cowork 와 Code · 크롬 · 엑셀 | p.75–88 · p.104–111 |
| **[09](09_실전_경매물건분석.md)** | 실전 — 경매 물건 분석 | 섹션 05에서 붙인 MCP 를 본격적으로 씁니다 | p.89–97 |
