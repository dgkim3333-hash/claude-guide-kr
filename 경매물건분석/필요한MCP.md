...
MCP(Model Context Protocol)는 Claude가 밖깥 자료를 직접 가져오게 해주는 연결 장치입니다.
...
공개 패키지입니다 — `github.com/chrisryugj/korean-law-mcp`
...
**OC 발급** — https://open.law.go.kr 에서 신청합니다. 무료이고 **이메일 아이디**가 곳 OC입니다.
...
**공공데이터포털는 키 하나로 여러 서비스를 씁니다.** 다만 서비스마다
**활용신청**을 따로 눌러야 그 서비스가 열립니다. 승인까지 시간이 걸리는 것도 있습니다.

---

## 연결이 안 될 때 확인 순서

1. **Claude 데스크탑을 완전히 꺼다 켰습니까?** — 설정을 바꾸면 재시작해야 반영됩니다
